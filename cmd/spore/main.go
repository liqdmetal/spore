...
func usage() {
  ...
  spore continuity create|check-in|status|release|verify|observe ...       (encrypted continuity vault; observer emits signed release-ready notice; no automatic funds)
