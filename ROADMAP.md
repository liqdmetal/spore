...
| 8 | **Relay fabric interconnection** | Relay nodes forwarding encrypted pointer/body across a substrate mesh (Waku/Iroh/libp2p). The spore-peer work is the body half; this is the pointer-forwarding half. |
