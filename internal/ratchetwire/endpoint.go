...
// local keystore.
//
// Per docs/RATCHET.md §6, the 0xE2 envelope's authentication is the X3DH
// handshake plus the double-ratchet chain itself: there is deliberately NO
// outer envelope-v2 (0xE1) signature on ratcheted frames — a per-message
// Ed25519 signature would be redundant and would reintroduce the
// double-wrapping and send/recv asymmetry removed by the E2 audit (H1/H2).
// Sender attribution comes from X3DH binding both pinned identities; see
// RATCHET.md §6 and SENDER_AUTH.md.
